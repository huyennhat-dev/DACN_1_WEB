          ...
          <div class="col-12 col-sm-9 detail-body">
                  ...
                  <div class="col-12 col-sm-4 detail-main-left">
                    <div class="px-2">
                      <div class="img-wrapper w-100 shadow-full brr-5">
                        ...
                        <div
                          id="img-zoom"
                          class="img-zoom-rs shadow-full brr-2"
                        ></div>
                      </div>
                    </div>
                    <div class="px-2 mt-3" v-if="product.photos.length > 1">
                  ...
                  >
                    ...
                    <div class="row px-1">
                      <div class="col-12 px-4">
                        ...
                        <div class="col-12">
                          <span class="text-black fs-small"
                            >Giá niêm yết :
                          </span>
                          <span
                        ...
                        <div class="col-12">
                          <span class="text-black fs-small me-3"
                            >Tình trạng :
                          </span>
                          <span
                          ...
                          <span
                            v-else
                            class="text-primary fw-normal opacity-100"
                          >
                            Còn hàng
                          </span>
                        </div>
            ...
            <div class="col-12 pb-2">
              <div class="book-desc px-3 px-sm-4 brr-10">
                <div class="px-2 py-3">
                  <span class="fs-5 fw-bold text-back"> Mô tả sản phẩm </span>
                </div>
